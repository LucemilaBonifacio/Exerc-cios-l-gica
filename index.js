...
let carteira = Number(prompt("Informe o valor que tem:"));
...
let prova1 = Number(prompt ("Informe a nota da prova 1 :"));
let prova2 = Number(prompt ("Informe a nota da prova 2:"));
...
let ingressoTipo = prompt("Escolha o tipo de ingresso:\n1 - VIP\n2 - Standard");

let pipocaOpcao = prompt("Deseja o combo de pipoca?\n1 - Sim\n2 - Não");

// Ingresso VIP
if (ingressoTipo == "1") { 
  if (pipocaOpcao == "1") { 
    alert("Valor: 110 reais");
  } else { 
    alert("Valor: 80 reais");
  }

// Ingresso Standard
} else if (ingressoTipo == "2") { 
  if (pipocaOpcao == "1") { 
    alert("Valor: 70 reais");
  } else {
    alert("Valor: 40 reais");
  }
//Nenhuma opção
} else {
